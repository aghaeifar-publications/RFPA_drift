...
target_folder  = '~/rawdata/RFPA'
twix_file_path = os.path.join(target_folder, sys.argv[1])
...
corr_interval = 3 # correct for every nth RF
...
predictive_output = '~/RFPA_drift_correction.txt'
